  ...
  return (
    <div className='invoice-page container'>
      <header className='header flow' style={{ '--flow-spacing': '2rem' }}>
        ...
        <div className='main-content invoice-controls bg-neutral flex justify-sb align-center'>
      ...
      <main className='invoice-details grid bg-neutral' style={{ '--gap': '3rem' }}>
        ...
        <div className='flex justify-start align-start' style={{ '--gap': '8rem' }}>
        ...
        <div>
          ...
          <div className='total-cost flex align-center justify-sb'>
            ...
            <p className='fs-300 fw-bold text-white'>£ {total}</p>
          </div>
        </div>
      </main>
    </div>
